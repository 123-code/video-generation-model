...
class VideoDiT(nn.Module):
    def __init__(self,in_channels=8,T=16,H=64,W=64,patch_size=2,dim=768,depth=6,heads=8):
        super().__init__()
        ...
        self.blocks = nn.ModuleList([VideoDiTBlock(dim,heads,num_frames=num_frames,spatial_size=spatial_size) for _ in range(depth)])
